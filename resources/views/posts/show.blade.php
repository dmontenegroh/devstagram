    ...
    <div class="container mx-auto md:flex gap-5">
        <div class="md:w-1/2">
            ...
            <div class="p-3 flex items-center gap-1">
                ...
                @auth
                    {{-- @php
                        $mensaje = 'Hola mundo desde una varible en show';
                    @endphp --}}
            ...
            @auth
                @if ($post->user_id == auth()->user()->id)
                    {{-- Como no existe el metodo DELETE en el navegador usamos el METhOD SPOOFING --}}
        ...
        <div class="md:w-1/2">
            <div class="shadow bg-white p-5 mb-5">
                ...
                <div id="caja-comentarios" class="bg-white shadow mb-5 max-h-96 overflow-y-auto">
                ...
                @auth
                    <p class="text-xl font-bold text-center mb-4">Agrega un Nuevo Comenario</p>
                    @if (session('mensaje'))
